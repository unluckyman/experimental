 ...
 *
 */
class ProjectImagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'project_images_ibfk_1' => ['type' => 'foreign', 'columns' => ['project_id'], 'references' => ['projects', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'project_id' => 1,
            'created' => '2015-09-07 21:24:48',
            'modified' => '2015-09-07 21:24:48'
        ],
    ];
}
